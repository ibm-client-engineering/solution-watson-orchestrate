...
async function createconfig() {
  ...
  const config = {
    ...
    baseUrl: '/solution-watson-orchestrate/',


    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: 'ibm-client-engineering', // Usually your GitHub org/user name.
    projectName: 'solution-watson-orchestrate', // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              'https://github.com/ibm-client-engineering/solution-watson-orchestrate/tree/main/packages/create-docusaurus/templates/shared/',
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              `https://github.com/ibm-client-engineering/solution-watson-orchestrate/edit/main/${blogDirPath}/${blogPath}`,
    ...
    themeConfig:
      ...
      ({
        ...
        navbar: {
          title: '| Watson Orchestrate w/ WatsonX, BAW, AWS Lambda ',
          logo: {
            alt: 'My Site Logo',
            src: 'img/logo.svg',
          ...
          items: [
            ...
            {
              href: 'https://github.com/ibm-client-engineering/solution-watson-orchestrate',
